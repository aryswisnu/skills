...
export function buildBackendComment(summary, base, head, pr, imageUrl = null, mermaid = null, diagram = null) {
  ...
  if (imageUrl) {
    ...
    lines.push(mermaid
      ? '> Generated by `visualize-pr`. The change map shows changed files and their in-repo imports, marked added, modified, deleted, or unchanged. Nothing here is an approval.'

...
export function buildBackendComment(summary, base, head, pr, imageUrl = null, mermaid = null, diagram = null) {
  ...
  if (imageUrl) {
    ...
    lines.push(mermaid
      ? '> Generated by `visualize-pr`. The change map is a Mermaid graph of changed files and their in-repo imports; colors mark added, modified, deleted, and unchanged files. Nothing here is an approval.'

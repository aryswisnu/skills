...
Release history lives in the repository [CHANGELOG.md](../../../../CHANGELOG.md). This document records the v0.3.0 end-to-end verification procedure and its observed results.
...
After moving the skill to `skills/engineering/visualize-pr/`, verification was rerun from the
...
Observed: exactly one installable skill, `visualize-pr`. A new two-commit scratch repository

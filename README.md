...
<p align="center">
  ...
  <a href="skills/engineering/visual-pr-review/docs/pr-comment-examples.md">See the PR comment</a> ·
...
This is a real side-by-side image generated by the CLI from two commits:
...
- a module and file-level change summary for backend reviews.
...
| **Backend / non-web** | Reads the Git diff without starting a browser, then writes a change summary and editorial `architecture.svg` change map. |
...
The current implementation is covered by 135 tests, including real-browser checks when Chromium is
